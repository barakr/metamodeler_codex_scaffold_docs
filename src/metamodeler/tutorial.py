...
Typical first cell of a tutorial notebook::
    ...
    from metamodeler.tutorial import bootstrap, run_cli
    ROOT = bootstrap()
...
def run_cli(
    *args: str,
    ...
    """Invoke `python -m metamodeler.cli.main <args>` cross-platform.
    ...
    cmd = [sys.executable, "-m", "metamodeler.cli.main", *args]
